...
class TaskController extends Controller
{
    ...
    public function store(CreatedTaskRequest $request){
        ...
        $task->task_list_id= $request->tasklistid;
        $task->save();
        return response()->json(['message' => "Successfully creaetd", "data" => $task]);
    }
    ...
    public function update(UpdateTaskRequest $request, $taskId){
        ...
        return response()->json(['message' => "Successfully updated", "data" => $task]);
    }
    ...
    public function delete($taskId){
        ...
        if($task->created_by == auth()->user()->id){
            $task->delete();
            return response()->json(['message' => "Successfully deleted", "data" => $task]);
        }else{
